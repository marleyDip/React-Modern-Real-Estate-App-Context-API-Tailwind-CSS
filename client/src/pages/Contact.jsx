  ...
  return (
    <div className="bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28">
      <form className="flex flex-col items-center text-sm text-slate-800">
        ...
        <p className="max-md:text-sm text-gray-500 pb-10 text-center font-semibold">
          Or just reach out manually to us at{" "}
          <a
            href="https://marleydip.netlify.app/"
            target="_blank"
            className="text-indigo-600 hover:underline hover:text-lime-600"
          >
            Md Sofian Hasan
          </a>
        </p>
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full bg-secondary/10  focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
            ...
            <input
              type="text"
              className="h-full px-2 w-full outline-none bg-transparent placeholder-gray-500"
          ...
          <textarea
            rows="4"
            className="w-full mt-2 p-2 bg-secondary/10 border border-slate-300 rounded-lg resize-none outline-none  focus:ring-2 focus-within:ring-indigo-400 transition-all placeholder-gray-500"
