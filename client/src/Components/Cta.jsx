    ...
    <section className="bg-[#fffbee] pt-16 xl:pt-24">
      <div className="max-padd-container mx-2 md:mx-auto p-px">
        <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px]">
          ...
          <p className="text-slate-500 font-medium mt-2 max-w-lg max-md:text-sm">
          ...
          <button
            type="button"
            className="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm px-5 py-2.5 rounded-xl shadow-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300"
          >
            Get Started Today
          </button>
        </div>
